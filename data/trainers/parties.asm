...
WhitneyGroup:
	...
	db 47
	dw WIGGLYTUFF
	db SING, SLAM, ICE_BEAM, ATTRACT
	db 49
	dw GRANBULL
	db CRUNCH, TAKE_DOWN, SWAGGER, DYNAMICPUNCH
	db 50
	dw MILTANK
	db EARTHQUAKE, ATTRACT, SLAM, MILK_DRINK
	db -1 
...
BugsyGroup:
	...
	db 15
	dw LEDIAN 
	db TACKLE, SUPERSONIC, POWERUPPUNCH, NO_MOVE
	db 16
	dw SCYTHER
...
ChuckGroup:
	...
	db 28
	dw TYROGUE
	db TACKLE, FORESIGHT, JUMP_KICK, NO_MOVE
	db 27
	dw PRIMEAPE
	db LEER, RAGE, POWERUPPUNCH, FURY_SWIPES
	db 30
	dw POLIWRATH
	...
	db 45
	dw HITMONTOP
	db RAPID_SPIN, FORESIGHT, JUMP_KICK, STRENGTH
	db 47
	dw PRIMEAPE
	db ROCK_SLIDE, FOCUS_ENERGY, CROSS_CHOP, MEGA_KICK
	db 49
	dw HERACROSS
	db MEGAHORN, COUNTER, SWAGGER, PROTECT
	db 50
	dw POLIWRATH
	db HYPNOSIS, MUD_SHOT, HYDRO_PUMP, DYNAMICPUNCH
	db -1
...
Rival1Group:
	...
	db 32
	dw MEGANIUM
	db REFLECT, RAZOR_LEAF, POISONPOWDER, SLAM
	db -1 
	...
	db 35
	dw KADABRA
	db DISABLE, PSYBEAM, RECOVER, RECOVER
	db 38
	dw FERALIGATR
...
WillGroup:
	...
	db 40
	dw XATU
	db QUICK_ATTACK, CONFUSION, CONFUSE_RAY, PSYCHIC_M
	db 41
	dw GIRAFARIG
	db AGILITY, BATON_PASS, HEADBUTT, PSYCHIC_M
	db 41
	dw EXEGGUTOR
	db REFLECT, LEECH_SEED, STOMP, PSYCHIC_M
	db 41
	dw SLOWKING
	db CURSE, AMNESIA, SLAM, PSYCHIC_M
	db 42
	dw XATU
	db QUICK_ATTACK, CONFUSION, CONFUSE_RAY, PSYCHIC_M
	db -1 
...
BrunoGroup:
	...
	db 42
	dw HITMONTOP
	db PURSUIT, QUICK_ATTACK, DIG, PROTECT
	db 42
	dw HITMONLEE
	db SWAGGER, DOUBLE_KICK, JUMP_KICK, FORESIGHT
	db 42
	dw HITMONCHAN
	db THUNDERPUNCH, ICE_PUNCH, FIRE_PUNCH, MACH_PUNCH
	db 43
	dw ONIX
	db WRAP, EARTHQUAKE, SANDSTORM, ROCK_SLIDE
	db 46
	dw MACHAMP
	db ROCK_SLIDE, FORESIGHT, DYNAMICPUNCH, CROSS_CHOP
	db -1 
...
KarenGroup:
	...
	db 42
	dw VILEPLUME
	db STUN_SPORE, SLUDGE, MOONLIGHT, PETAL_DANCE
	db 45
	dw GENGAR
...
KogaGroup:
	...
	db 42
	dw MUK
	db DOUBLE_TEAM, ACID_ARMOR, SLUDGE_BOMB, TOXIC
	db 44
	dw CROBAT
...
BrockGroup:
	...
	db 44
	dw ONIX
	db WRAP, ROCK_SLIDE, SLAM, SANDSTORM
	db 42
	dw KABUTOPS
...
ErikaGroup:
	...
	db 46
	dw VICTREEBEL
	db SUNNY_DAY, SYNTHESIS, SLUDGE, RAZOR_LEAF
	db 46
	dw VILEPLUME
...
BirdKeeperGroup:
	...
	db 40
	dw FARFETCH_D
	db FURY_ATTACK, PROTECT, FLY, SLASH
	db -1 ; end
...
CooltrainerFGroup:
	...
	db 25
	dw GLOOM
	db ABSORB, STUN_SPORE, SLUDGE, SOLARBEAM
	db -1 
...
SabrinaGroup:
	...
	db 48
	dw ALAKAZAM
	db RECOVER, PSYBEAM, PSYCHIC_M, REFLECT
	db -1 ; end
...
SailorGroup:
	...
	db 18
	dw KRABBY
	db BUBBLE, LEER, METAL_CLAW, HARDEN
	db 20
	dw KRABBY
...
Rival2Group:
	...
	db 43
	dw ALAKAZAM
	db DISABLE, RECOVER, REFLECT, PSYCHIC_M
	db 45
	dw MEGANIUM
	db RAZOR_LEAF, POISONPOWDER, SLAM, LIGHT_SCREEN
	db -1 ; end
	...
	db 46
	dw ALAKAZAM
	db RECOVER, DISABLE, PSYCHIC_M, REFLECT
	db 50
	dw MEGANIUM
	db GIGA_DRAIN, SLAM, LIGHT_SCREEN, SAFEGUARD
	db -1 ; end
...
BlackbeltGroup:
	...
	db 27
	dw HITMONLEE
	db DOUBLE_KICK, FORESIGHT, JUMP_KICK, FOCUS_ENERGY
	db -1 ; end
	...
	db 25
	dw MACHOP
	db LEER, FOCUS_ENERGY, POWERUPPUNCH, SEISMIC_TOSS
	db 25
	dw MACHOKE
...
PicnickerGroup:
	...
	db 31
	dw CLEFAIRY
	db ENCORE, SING, DOUBLESLAP, DOUBLE_TEAM
	db -1 ; end
	...
	db 37
	dw CLEFAIRY
	db ENCORE, DOUBLESLAP, DOUBLE_TEAM, METRONOME
	db -1 ; end
...
ExecutiveFGroup:
	...
	db 32
	dw VILEPLUME
	db ABSORB, SWEET_SCENT, SLEEP_POWDER, SLUDGE
	db 32
	dw MURKROW
...
BlueGroup:
	...
	db 58
	dw EXEGGUTOR
	db SUNNY_DAY, LEECH_SEED, STOMP, SOLARBEAM
	db 58
	dw ARCANINE
...
NekrobaGroup:
	...
	db 53
	dw SKARMORY
	db STEEL_WING, RECOVER, DRILL_PECK, SPIKES
	dw $9A77
	db "HALBIRD@"
	db 54
	dw ESPEON
...
DiogoGroup:
	...
	db 52
	dw WEAVILE
	db DOUBLE_TEAM, SLASH, LOW_KICK, ICE_PUNCH
	dw $CA76
	db "WEAVILE@"
	db 53
	dw CROBAT
