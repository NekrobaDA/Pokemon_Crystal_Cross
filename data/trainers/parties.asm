...
FalknerGroup:
	...
	db  7, GLIGAR,     POISON_STING, SAND_ATTACK, NO_MOVE, NO_MOVE
...
BugsyGroup:
	...
	db 14, BUTTERFREE, CONFUSION, STRING_SHOT, TACKLE, NO_MOVE
	db 15, LEDIAN,     TACKLE, SUPERSONIC, COMET_PUNCH, NO_MOVE
...
MortyGroup:
	...
	db 23, MISDREAVUS, PSYWAVE, MEAN_LOOK, SPITE, CONFUSE_RAY
	db -1 ; end

PryceGroup:
	; PRYCE (1)
	db "PRYCE@", TRAINERTYPE_MOVES
	db 27, DELIBIRD,   PRESENT, ICY_WIND, NO_MOVE, NO_MOVE
...
JasmineGroup:
	...
	db 30, SKARMORY,   PECK, SAND_ATTACK, AGILITY, STEEL_WING
...
ChuckGroup:
	...
	db 28, TYROGUE,    TACKLE, MIND_READER, HI_JUMP_KICK, NO_MOVE
...
ClairGroup:
	...
	db 37, CHARMELEON, METAL_CLAW, FLAMETHROWER, SMOKESCREEN, DRAGONBREATH
...
WillGroup:
	...
	db 41, GIRAFARIG,  AGILITY, BATON_PASS, HEADBUTT, PSYCHIC_M
...
SchoolboyGroup:
	...
	db 32, SUNFLORA,    SUNNY_DAY, PETAL_DANCE, GROWTH, MEGA_DRAIN
	...
	db 34, HYPNO,   PSYCHIC_M, LIGHT_SCREEN, REFLECT, POISON_GAS
...
CooltrainerFGroup:
	...
	db 25, GLOOM,  ABSORB, STUN_SPORE, ACID, SOLARBEAM
	db -1 ; end
...
SabrinaGroup:
	...
	db 46, SLOWBRO,   AMNESIA, REFLECT, DISABLE, PSYCHIC_M
