...
FalknerGroup:
	...
	db 50
	dw PIDGEOT
	db RAZOR_WIND, MUD_SLAP, DOUBLE_TEAM, SWIFT
	db -1 
...
WhitneyGroup:
	...
	db 45
	dw CLEFABLE
	db PSYBEAM, FLASH, MOONLIGHT, METRONOME
	db 47
	dw WIGGLYTUFF
	db SING, BODY_SLAM, ICE_BEAM, ATTRACT
	db 49
	dw GRANBULL
	db CRUNCH, TAKE_DOWN, SWAGGER, DYNAMICPUNCH
	db 50
	dw MILTANK
	db EARTHQUAKE, ATTRACT, BODY_SLAM, MILK_DRINK
	db -1 
...
BugsyGroup:
	...
	db 14
	dw BUTTERFREE
	db CONFUSION, STRING_SHOT, TACKLE, NO_MOVE
	db 15
	dw LEDIAN 
	...
	db 45
	dw BUTTERFREE
	db PSYBEAM, SAFEGUARD, STUN_SPORE, GIGA_DRAIN
	db 47
	dw LEDIAN 
	db DYNAMICPUNCH, LIGHT_SCREEN, REFLECT, ICE_PUNCH
	db 49
	dw YANMEGA
	db LEECH_LIFE, DOUBLE_TEAM, RAZOR_WIND, SHADOW_BALL
	db 50
	dw SCIZOR
	db SWORDS_DANCE, METAL_CLAW, FURY_CUTTER, RAZOR_WIND
	db -1 
...
MortyGroup:
	...
	db 47
	dw HAUNTER
	db HYPNOSIS, MEAN_LOOK, SHADOW_BALL, DREAM_EATER
	db 49
	dw MISMAGIUS
	db ICY_WIND, MEAN_LOOK, SHADOW_BALL, PERISH_SONG
	db 50
	dw GENGAR
	db THUNDERBOLT, SHADOW_BALL, DESTINY_BOND, PSYCHIC_M
	db -1 
...
PryceGroup:
	...
	db 45
	dw DEWGONG
	db HEADBUTT, ICY_WIND, BLIZZARD, REST
	db 47
	dw CLOYSTER
	db ICE_BEAM, SPIKES, SPIKE_CANNON, BUBBLEBEAM
	db 49
	dw DEWGONG
	db HEADBUTT, ICY_WIND, PERISH_SONG, WHIRLPOOL
	db 50
	dw PILOSWINE
	db ICY_WIND, FURY_ATTACK, ROCK_SLIDE, MAGNITUDE
	db -1 
...
JasmineGroup:
	...
	db 45
	dw MAGNETON
	db THUNDER, SUPERSONIC, RAIN_DANCE, THUNDER_WAVE
	db 47
	dw SKARMORY
	db DOUBLE_TEAM, DRILL_PECK, SPIKES, STEEL_WING
	db 49
	dw MAGNETON
	db THUNDERBOLT, SUPERSONIC, LOCK_ON, ZAP_CANNON
	db 50
	dw STEELIX
	db SCREECH, SUNNY_DAY, EARTHQUAKE, IRON_TAIL
	db -1
...
ChuckGroup:
	...
	db 28
	dw TYROGUE
	db TACKLE, MIND_READER, HI_JUMP_KICK, NO_MOVE
	db 27
	dw PRIMEAPE
	...
	db 45
	dw HITMONTOP
	db RAPID_SPIN, MIND_READER, HI_JUMP_KICK, STRENGTH
	db 47
	dw PRIMEAPE
	db ROCK_SLIDE, FOCUS_ENERGY, CROSS_CHOP, MEGA_KICK
	db 49
	dw HERACROSS
	db MEGAHORN, COUNTER, SWAGGER, DETECT
	db 50
	dw POLIWRATH
	db HYPNOSIS, MIND_READER, HYDRO_PUMP, DYNAMICPUNCH
	db -1
...
ClairGroup:
	...
	db 45
	dw DRAGONAIR
	db THUNDER_WAVE, THUNDERBOLT, LIGHT_SCREEN, DRAGONBREATH
	db 47
	dw DRAGONITE
	db OUTRAGE, WING_ATTACK, SLAM, DRAGONBREATH
	db 49
	dw DRAGONAIR
	db THUNDER_WAVE, ICE_BEAM, SAFEGUARD, DRAGONBREATH
	db 50
	dw KINGDRA
	db OCTAZOOKA, ICE_BEAM, HYPER_BEAM, DRAGONBREATH
	db -1
...
WillGroup:
	...
	db 41
	dw GIRAFARIG
	db AGILITY, BATON_PASS, HEADBUTT, PSYCHIC_M
	db 41
	dw EXEGGUTOR
...
ErikaGroup:
	...
	db 42
	dw LEAFEON
	db RAZOR_LEAF, GROWTH, GIGA_DRAIN, FURY_CUTTER
	db 41
	dw JUMPLUFF
...
SchoolboyGroup:
	...
	db 34
	dw HYPNO
	db PSYCHIC_M, LIGHT_SCREEN, REFLECT, POISON_GAS
	db 38
	dw MAGNETON
...
SabrinaGroup:
	...
	db 46
	dw SLOWBRO
	db AMNESIA, REFLECT, DISABLE, PSYCHIC_M
	db 48
	dw ALAKAZAM
