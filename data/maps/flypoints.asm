...
; Sevii
	db LANDMARK_ONE_ISLAND,       SPAWN_ONE
	db LANDMARK_TWO_ISLAND,       SPAWN_TWO
	db LANDMARK_THREE_ISLAND,     SPAWN_THREE
	db LANDMARK_FOUR_ISLAND,      SPAWN_FOUR
	db LANDMARK_FIVE_ISLAND,      SPAWN_FIVE
	db LANDMARK_SIX_ISLAND,       SPAWN_SIX
	db LANDMARK_SEVEN_ISLAND,     SPAWN_SEVEN
	db -1 ; end
