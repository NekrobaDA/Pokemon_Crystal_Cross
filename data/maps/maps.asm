...
MapGroup_Olivine:
	...
	map Route38, TILESET_KANJO, ROUTE, LANDMARK_ROUTE_38, MUSIC_ROUTE_37, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route39, TILESET_KANJO, ROUTE, LANDMARK_ROUTE_39, MUSIC_ROUTE_37, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_Blackthorn:
	...
	map Route45, TILESET_KANJO, ROUTE, LANDMARK_ROUTE_45, MUSIC_ROUTE_36, FALSE, PALETTE_AUTO, FISHGROUP_DRATINI_2
...
MapGroup_Violet:
	...
	map Route35, TILESET_KANJO, ROUTE, LANDMARK_ROUTE_35, MUSIC_ROUTE_36, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map Route36, TILESET_KANJO, ROUTE, LANDMARK_ROUTE_36, MUSIC_ROUTE_36, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route37, TILESET_KANJO, ROUTE, LANDMARK_ROUTE_37, MUSIC_ROUTE_36, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_NewBark:
	...
	map Route29, TILESET_KANJO, ROUTE, LANDMARK_ROUTE_29, MUSIC_ROUTE_29, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map NewBarkTown, TILESET_KANJO, TOWN, LANDMARK_NEW_BARK_TOWN, MUSIC_NEW_BARK_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
...
MapGroup_Cherrygrove:
	map Route30, TILESET_KANJO, ROUTE, LANDMARK_ROUTE_30, MUSIC_ROUTE_30, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map Route31, TILESET_KANJO, ROUTE, LANDMARK_ROUTE_31, MUSIC_ROUTE_30, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map CherrygroveCity, TILESET_KANJO, TOWN, LANDMARK_CHERRYGROVE_CITY, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_Catallia:
	map Route47, TILESET_KANJO, ROUTE, LANDMARK_ROUTE_30, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map CatalliaTown, TILESET_KANJO, TOWN, LANDMARK_CHERRYGROVE_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map CatalliaMart, TILESET_MART, INDOOR, LANDMARK_CHERRYGROVE_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CatalliaPokecenter1F, TILESET_POKECENTER, INDOOR, LANDMARK_CHERRYGROVE_CITY, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CatalliaPoliceStation, TILESET_FACILITY, INDOOR, LANDMARK_ROUTE_30, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CatalliaHouse1, TILESET_HOUSE, INDOOR, LANDMARK_CHERRYGROVE_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CatalliaHouse2, TILESET_HOUSE, INDOOR, LANDMARK_CHERRYGROVE_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_SeviiTwo:
	map TwoIsland, TILESET_SEVII, TOWN, LANDMARK_TWO_ISLAND, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	...
	map CapeBrink, TILESET_SEVII, ROUTE, LANDMARK_CAPE_BRINK, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_AUTO, FISHGROUP_POND
	
MapGroup_SeviiThree:
	map ThreeIsland, TILESET_SEVII, TOWN, LANDMARK_THREE_ISLAND, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	...
	map BondBridge, TILESET_SEVII, ROUTE, LANDMARK_BOND_BRIDGE, MUSIC_ROUTE_37, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map BerryForest, TILESET_PARK, ROUTE, LANDMARK_BERRY_FOREST, MUSIC_ROUTE_2, FALSE, PALETTE_AUTO, FISHGROUP_POND
...
MapGroup_SeviiSix:
	...
	map WaterPath, TILESET_SEVII, ROUTE, LANDMARK_WATER_PATH, MUSIC_ROUTE_30, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map RuinValley, TILESET_SEVII, ROUTE, LANDMARK_RUIN_VALLEY, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map PatternBush, TILESET_PARK, ROUTE, LANDMARK_PATTERN_BUSH, MUSIC_MT_MOON, FALSE, PALETTE_AUTO, FISHGROUP_POND
	
MapGroup_SeviiSeven:
	map SevenIsland, TILESET_SEVII, TOWN, LANDMARK_SEVEN_ISLAND, MUSIC_VIOLET_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
