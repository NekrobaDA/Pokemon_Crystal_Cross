...
MapGroup_CherrygroveNeo:
	map CherrygroveCity, TILESET_CHERRYGROVE, TOWN, LANDMARK_CHERRYGROVE_CITY, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_Underwater:
	map DiveTest, TILESET_UNDERWATER, ROUTE, LANDMARK_CHERRYGROVE_CITY, MUSIC_MOBILE_ADAPTER, TRUE, PALETTE_NITE, FISHGROUP_NONE
