...
MapGroup_Olivine:
	...
	map Route38, TILESET_KANJO, ROUTE, LANDMARK_ROUTE_38, MUSIC_ROUTE_38, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route39, TILESET_KANJO, ROUTE, LANDMARK_ROUTE_39, MUSIC_ROUTE_38, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
