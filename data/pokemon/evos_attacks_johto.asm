...
TogekissEvosAttacks:                 ;updated
	db 0 ; no more evolutions
	dbw 1, TRI_ATTACK      ;move relearner
	dbw 1, AURA_SPHERE     ;move relearner
	dbw 1, POUND
	dbw 1, GROWL
	dbw 4, METRONOME
	dbw 9, CHARM
	...
	dbw 31, ENCORE
	dbw 37, WISH
	dbw 40, AIR_SLASH      ;evolution move
	dbw 44, SAFEGUARD
	dbw 49, TAKE_DOWN
	dbw 53, BATON_PASS
	dbw 54, EXTREMESPEED
...
GranbullEvosAttacks:                 ;
	db 0 ; no more evolutions
	dbw 1, ICE_FANG   ;change, add SUPERPOWER as relearn
	dbw 1, FIRE_FANG  ;possibly make fangs egg moves
	dbw 1, TACKLE
	dbw 1, LICK
	dbw 4, CHARM
	dbw 7, BITE
...
PiloswineEvosAttacks:                ;
	db 0 ; no more evolutions
	dbw 1, ICE_FANG       ;add SUPERPOWER as relearn move
	dbw 1, PECK
	dbw 1, HOWL
	dbw 4, POWDER_SNOW
	dbw 8, MUD_SLAP
...
LugiaEvosAttacks:                    ;
	db 0 ; no more evolutions
	dbw 1, TWISTER       ;consider dragonbreath
	dbw 1, REFRESH
	dbw 4, CONFUSION
	dbw 7, WHIRLWIND
	dbw 12, RAIN_DANCE
...
HoOhEvosAttacks:                     ;
	db 0 ; no more evolutions
	dbw 1, DRAGONBREATH  ;move relearner
	dbw 1, GUST
	dbw 1, REFRESH
	dbw 4, CONFUSION
	dbw 7, WHIRLWIND
...
Vulpix_AlolanEvosAttacks:            ;updated
...
Pichu_SpikyEvosAttacks:              ;updated
...
Pikachu_CloneEvosAttacks:            ;updated
	...
	dbw 37, DISCHARGE
	dbw 42, LIGHT_SCREEN
	dbw 45, THUNDER        ;->VOLT_TACKLE
	db 0 ; no more level-up moves

Raichu_CloneEvosAttacks:             ;updated
	db 0 ; no more evolutions
...
Raichu_AlolanEvosAttacks:            ;updated
	db 0 ; no more evolutions
	dbw 1, VOLT_TACKLE     ;move relearner
	dbw 1, NASTY_PLOT      ;pre-evolution, move relearner
	dbw 1, THUNDERSHOCK
	...
	dbw 18, SPARK
	dbw 21, DOUBLE_TEAM
	dbw 25, PSYSHOCK       ;evolution move
	dbw 29, SLAM
	dbw 33, THUNDERBOLT
	dbw 37, AGILITY
	dbw 44, DISCHARGE
...
Arbok_KantoEvosAttacks:              ;updated
	db 0 ; no more evolutions
	dbw 1, BASILISKFANG    ;move relearner
	dbw 1, REFRESH         ;move relearner
	dbw 1, WRAP
...
Arbok_SeviiEvosAttacks:              ;updated
	db 0 ; no more evolutions
	dbw 1, CRUNCH          ;move relearner
	dbw 1, REFRESH         ;move relearner
	dbw 1, WRAP
	dbw 1, LEER
	dbw 4, POISON_STING
