...
MetapodEvosAttacks:                  ;updated
	dbbw EVOLVE_LEVEL, 10, BUTTERFREE
	db 0 ; no more evolutions
	dbw 1, TACKLE
	dbw 7, HARDEN          ;evolution move
	dbw 15, IRON_DEFENSE
	dbw LEARN_EVO_MOVE, HARDEN
	db 0 ; no more level-up moves

ButterfreeEvosAttacks:               ;updated
	db 0 ; no more evolutions
	dbw 1, PSYCH_UP        ;move relearner
	dbw 1, BUG_BITE        ;pre-evolution, move relearner
	dbw 1, TACKLE
	dbw 1, STRING_SHOT
	dbw 7, SUPERSONIC      ;evolution move
	dbw 10, CONFUSION      ;evolution move
	dbw 12, EFFECT_SPORE
	dbw 16, GUST
	dbw 22, SLEEP_POWDER
	dbw 24, PSYBEAM
	...
	dbw 46, BUG_BUZZ
	dbw 53, QUIVER_DANCE
	dbw LEARN_EVO_MOVE, SUPERSONIC
	dbw LEARN_EVO_MOVE, CONFUSION
	db 0 ; no more level-up moves

WeedleEvosAttacks:                   ;updated
...
BeedrillEvosAttacks:                 ;updated
	db 0 ; no more evolutions
	dbw 1, BATON_PASS      ;move relearner
	dbw 1, FELL_STINGER    ;pre-evolution, move relearner
	dbw 1, POISON_STING
	dbw 1, STRING_SHOT
	dbw 7, SHARPEN         ;evolution move
	dbw 10, FURY_ATTACK    ;evolution move
	dbw 13, FOCUS_ENERGY
	dbw 16, TWINEEDLE
	dbw 19, VENOSHOCK
	dbw 22, PURSUIT
...
PidgeotEvosAttacks:                  ;updated
	db 0 ; no more evolutions
	dbw 1, REFRESH         ;move relearner
	...
	dbw 27, FEATHERDANCE
	dbw 32, AGILITY
	dbw 36, FALCON_DIVE    ;evolution move
	dbw 39, TAKE_DOWN
	dbw 44, ROOST
	dbw 50, AIR_SLASH
	dbw 56, MIRROR_MOVE
	dbw 62, HURRICANE
	dbw LEARN_EVO_MOVE, FALCON_DIVE
	db 0 ; no more level-up moves

RattataEvosAttacks:                  ;updated
...
RaticateEvosAttacks:                 ;updated
	db 0 ; no more evolutions
	dbw 1, REFRESH         ;move relearner
	dbw 1, FACADE          ;move relearner
	dbw 1, TACKLE
	dbw 1, TAIL_WHIP
	dbw 4, QUICK_ATTACK
	dbw 7, FOCUS_ENERGY
	...
	dbw 16, FURY_SWIPES
	dbw 19, PURSUIT
	dbw 20, SCARY_FACE     ;evolution move
	dbw 29, SUPER_FANG
	dbw 34, SWAGGER
	dbw 39, SUCKER_PUNCH
	dbw 45, TAKE_DOWN
...
FearowEvosAttacks:                   ;updated
	db 0 ; no more evolutions
	dbw 1, BATON_PASS      ;move relearner
	dbw 1, SKY_ATTACK      ;move relearner
	dbw 1, PECK
	dbw 1, LEER
	dbw 4, SHARPEN
	dbw 9, FURY_ATTACK
...
EkansEvosAttacks:                    ;updated
	...
	dbw 17, POISON_FANG
	dbw 20, SCREECH
	dbw 25, ACID_SPRAY     ;->DRAGONBREATH
	dbw 28, MUD_BOMB
	dbw 36, POISON_TAIL
	dbw 41, CRUNCH         ;->BASILISKFANG
	dbw 44, COIL
	dbw 49, VENOMSTRIKE
	dbw 54, HAZE
	db 0 ; no more level-up moves

ArbokEvosAttacks:                    ;updated
	db 0 ; no more evolutions
	dbw 1, BASILISKFANG    ;move relearner
	dbw 1, REFRESH         ;move relearner
	dbw 1, WRAP
	dbw 1, LEER
	dbw 4, POISON_STING
	...
	dbw 17, POISON_FANG
	dbw 20, SCREECH
	dbw 24, SCARY_FACE     ;evolution move
	dbw 27, ACID_SPRAY
	dbw 32, MUD_BOMB
	dbw 39, POISON_TAIL
	dbw 44, CRUNCH
...
PikachuEvosAttacks:                  ;updated
	dbbw EVOLVE_ITEM_REGION_SEVII, THUNDERSTONE, RAICHU_ALOLAN
	dbbw EVOLVE_ITEM, THUNDERSTONE, RAICHU
	db 0 ; no more evolutions
	dbw 1, VOLT_TACKLE     ;move relearner
	dbw 1, NASTY_PLOT      ;pre-evolution, move relearner
	dbw 1, THUNDERSHOCK
	dbw 1, GROWL
	dbw 4, THUNDER_WAVE
	dbw 10, QUICK_ATTACK
	...
	dbw 37, DISCHARGE
	dbw 42, LIGHT_SCREEN
	dbw 45, THUNDER        ;->VOLT_TACKLE/PSYCHIC
	db 0 ; no more level-up moves

RaichuEvosAttacks:                   ;updated
	db 0 ; no more evolutions
	dbw 1, THUNDER_KICK    ;move relearner
	dbw 1, NASTY_PLOT      ;pre-evolution, move relearner
	dbw 1, THUNDERSHOCK
	dbw 1, GROWL
	dbw 4, THUNDER_WAVE
	...
	dbw 18, SPARK
	dbw 21, DOUBLE_TEAM
	dbw 25, THUNDERPUNCH   ;evolution move
	dbw 29, SLAM
	dbw 33, THUNDERBOLT
	dbw 37, AGILITY
	dbw 44, DISCHARGE
...
UmbreonEvosAttacks:                  ;   >I don't like it! I don't care-
	db 0 ; no more evolutions
...
LeafeonEvosAttacks:                  ;   >what it looks like to anyone else
	db 0 ; no more evolutions
...
GlaceonEvosAttacks:                  ;   >-I don't like it one bit!
	db 0 ; no more evolutions
