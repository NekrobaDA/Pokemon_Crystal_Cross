	...
	; tm/hm learnset
	tmhm SHADOW_RUSH, SUBMISSION, NIGHT_SHADE, COUNTER, SWORDS_DANCE, MEGA_KICK, MEGA_PUNCH, SUBSTITUTE, CALM_MIND, HAIL, DARK_PULSE, DRAGON_CLAW, DYNAMICPUNCH, HEADBUTT, CURSE, TOXIC, ROCK_SMASH, PSYCH_UP, HIDDEN_POWER, BLIZZARD, ICY_WIND, PROTECT, RAIN_DANCE, IRON_TAIL, RETURN, DIG, SHADOW_BALL, MUD_SLAP, DOUBLE_TEAM, ICE_PUNCH, SWAGGER, SLEEP_TALK, RAZOR_WIND, DREAM_EATER, REST, ATTRACT, THIEF, FURY_CUTTER, NIGHTMARE, CUT, SURF, STRENGTH, ICE_BEAM
	; end
