	...
	; tm/hm learnset
	tmhm SHADOW_RUSH, HEAL_BELL, STRENGTH, REFLECT, ROAR, HYPER_VOICE, SUBSTITUTE, CALM_MIND, AURA_SPHERE, HAIL, WATER_PULSE, DIG, SWIFT, MIMIC, HEADBUTT, CURSE, TOXIC, HIDDEN_POWER, SUNNY_DAY, ICE_BEAM, BLIZZARD, HYPER_BEAM, ICY_WIND, PROTECT, RAIN_DANCE, IRON_TAIL, RETURN, DIG, SHADOW_BALL, DOUBLE_TEAM, SLEEP_TALK, REST, ATTRACT, FLASH
	; end
