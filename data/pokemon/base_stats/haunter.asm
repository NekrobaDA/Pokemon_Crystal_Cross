	...
	; tm/hm learnset
	tmhm SHADOW_RUSH, PAIN_SPLIT, NIGHT_SHADE, SELFDESTRUCT, SUBSTITUTE, WILL_O_WISP, DARK_PULSE, MIMIC, CURSE, TOXIC, ZAP_CANNON, PSYCH_UP, HIDDEN_POWER, SUNNY_DAY, ICY_WIND, PROTECT, RAIN_DANCE, GIGA_DRAIN, THUNDER, RETURN, PSYCHIC_M, SHADOW_BALL, DOUBLE_TEAM, SWAGGER, SLEEP_TALK, DREAM_EATER, REST, ATTRACT, THIEF, NIGHTMARE, THUNDERBOLT
	; end
