	...
	; tm/hm learnset
	tmhm VOLT_TACKLE, SHADOW_RUSH, AURA_SPHERE, ROOST, SUBMISSION, THUNDER_WAVE, COUNTER, MEGA_KICK, SUBSTITUTE, LIGHT_SCREEN, SWIFT, MIMIC, CURSE, ROAR, TOXIC, ZAP_CANNON, ROCK_SMASH, HIDDEN_POWER, SUNNY_DAY, HYPER_BEAM, PROTECT, RAIN_DANCE, THUNDERBOLT, THUNDER, RETURN, DOUBLE_TEAM, SLEEP_TALK, SANDSTORM, RAZOR_WIND, REST, STEEL_WING, FLASH, THUNDERBOLT
	; end
