	...
	; tm/hm learnset
	tmhm TWISTER, THUNDER_WAVE, SUBSTITUTE, HAIL, DARK_PULSE, WATER_PULSE, OUTRAGE, MIMIC, DRAGONBREATH, HEADBUTT, CURSE, ROAR, TOXIC, ZAP_CANNON, EARTHQUAKE, ROCK_SMASH, HIDDEN_POWER, BLIZZARD, HYPER_BEAM, ICY_WIND, PROTECT, RAIN_DANCE, DRAGONBREATH, THUNDER, RETURN, DOUBLE_TEAM, SWAGGER, SLEEP_TALK, SANDSTORM, FIRE_BLAST, RAZOR_WIND, REST, ATTRACT, SURF, STRENGTH, WHIRLPOOL, WATERFALL, FLAMETHROWER, THUNDERBOLT, ICE_BEAM
	; end
