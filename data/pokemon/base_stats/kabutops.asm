	...
	; tm/hm learnset
	tmhm SUBMISSION, EARTH_POWER, SWORDS_DANCE, MEGA_KICK, SUBSTITUTE, HAIL, WATER_PULSE, ROCK_CLIMB, HEADBUTT, CURSE, ROLLOUT, TOXIC, ROCK_SMASH, HIDDEN_POWER, BLIZZARD, HYPER_BEAM, ICY_WIND, PROTECT, RAIN_DANCE, GIGA_DRAIN, RETURN, DOUBLE_TEAM, SWAGGER, SLEEP_TALK, SANDSTORM, ROCK_SLIDE, REST, ATTRACT, THIEF, FURY_CUTTER, CUT, SURF, WHIRLPOOL, ICE_BEAM
	; end
