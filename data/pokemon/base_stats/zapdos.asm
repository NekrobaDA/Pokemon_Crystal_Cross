	...
	; tm/hm learnset
	tmhm VOLT_TACKLE, SHADOW_RUSH, ROOST, TWISTER, THUNDER_WAVE, SUBSTITUTE, LIGHT_SCREEN, HAIL, SWIFT, MIMIC, CURSE, ROAR, TOXIC, ZAP_CANNON, ROCK_SMASH, HIDDEN_POWER, SUNNY_DAY, HYPER_BEAM, PROTECT, RAIN_DANCE, THUNDERBOLT, THUNDER, RETURN, MUD_SLAP, DOUBLE_TEAM, SWAGGER, SLEEP_TALK, SANDSTORM, RAZOR_WIND, REST, STEEL_WING, FLY, FLASH, THUNDERBOLT
	; end
