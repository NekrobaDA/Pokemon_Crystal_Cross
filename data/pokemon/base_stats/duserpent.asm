	...
	; tm/hm learnset
	tmhm SHADOW_RUSH, PAIN_SPLIT, ROOST, TWISTER, DOUBLE_EDGE, THUNDER_WAVE, SUBSTITUTE, CALM_MIND, WATER_PULSE, ICE_BEAM, DRAGONBREATH, RAZOR_WIND, SWIFT, MIMIC, OUTRAGE, HEADBUTT, CURSE, ROLLOUT, TOXIC, ZAP_CANNON, ROCK_SMASH, PSYCH_UP, HIDDEN_POWER, SUNNY_DAY, HYPER_BEAM, ICY_WIND, PROTECT, RAIN_DANCE, SOLARBEAM, IRON_TAIL, THUNDER, RETURN, DIG, MUD_SLAP, DOUBLE_TEAM, SWAGGER, SLEEP_TALK, DREAM_EATER, REST, ATTRACT, THIEF, STEEL_WING, NIGHTMARE, STRENGTH, FLY, FLAMETHROWER, THUNDERBOLT
	; end
