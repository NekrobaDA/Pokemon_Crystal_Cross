	...
	; tm/hm learnset
	tmhm SHADOW_RUSH, SEISMIC_TOSS, ROCK_SLIDE, SWIFT, THUNDERPUNCH, MEGA_PUNCH, MEGA_KICK, SWORDS_DANCE, OUTRAGE, SUBSTITUTE, COUNTER, WILL_O_WISP, MIMIC, DRAGON_CLAW, HEADBUTT, CURSE, TOXIC, ROCK_SMASH, HIDDEN_POWER, SUNNY_DAY, PROTECT, FLAMETHROWER, IRON_TAIL, DRAGON_PULSE, RETURN, DIG, DOUBLE_TEAM, SLEEP_TALK, FIRE_BLAST, REST, ATTRACT, FIRE_PUNCH, FURY_CUTTER, CUT, STRENGTH, FLAMETHROWER
	; end
