...
; ANIM_OBJ_PLAYERHEAD_2ROW
	...
	battleanimobj RELATIVE_X | X_FLIP, $a8, BATTLEANIMFRAMESET_67, BATTLEANIMFUNC_DIG, PAL_BATTLE_OB_BLUE, ANIM_GFX_SAND ; ANIM_OBJ_DIVE_1
	battleanimobj RELATIVE_X | X_FLIP, $a8, BATTLEANIMFRAMESET_68, BATTLEANIMFUNC_NULL, PAL_BATTLE_OB_BLUE, ANIM_GFX_SAND ; ANIM_OBJ_DIVE_2
