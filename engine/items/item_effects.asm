...
; entries correspond to item ids
	...
	dw NoEffect            ; MAIL
	dw EnergypowderEffect  ; GREEN_TEA
	dw EnergyRootEffect    ; ENERGY_ROOT
	dw HealPowderEffect    ; SOOTHE_BALM
	...
	dw NoEffect            ; DUBIOUS_DISC  ;make shell-smash like hold effect?
	...
	dw RestoreHPEffect     ; FRUIT_PUNCH
