...
EcruteakCity_MapScripts:
	...
	callback MAPCALLBACK_OBJECTS, .Eevee
...
.Eevee:
	checkflag ENGINE_SATURDAY_EEVEE
	iftrue .NoAppear
	readvar VAR_WEEKDAY
	ifequal SATURDAY, .Appear
.NoAppear:
	disappear SATURDAY_EEVEE
	endcallback

.Appear:
	appear SATURDAY_EEVEE
	endcallback

SaturdayEevee:
	faceplayer
	cry EEVEE
	loadwildmon EEVEE, 15
	startbattle
	disappear SATURDAY_EEVEE
	setflag ENGINE_SATURDAY_EEVEE
...
EcruteakCity_MapEvents:
	...
	def_object_events
	object_event 18, 15, SPRITE_GRAMPS, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, PAL_NPC_ROCK, OBJECTTYPE_SCRIPT, 0, EcruteakCityGramps1Script, -1
	object_event 20, 21, SPRITE_GRAMPS, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, PAL_NPC_ROCK, OBJECTTYPE_SCRIPT, 0, EcruteakCityGramps2Script, -1
	...
	object_event 26, 10, SPRITE_EEVEE, SPRITEMOVEDATA_POKEMON, 1, 1, -1, -1, PAL_NPC_ROCK, OBJECTTYPE_SCRIPT, 0, SaturdayEevee, EVENT_SATURDAY_EEVEE
