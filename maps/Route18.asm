	...
	const SATURDAY_LICKITUNG

Route18_MapScripts:
	def_scene_scripts

	def_callbacks
	callback MAPCALLBACK_OBJECTS, .Lickitung

.Lickitung:
	checkflag ENGINE_SATURDAY_LICKITUNG
	iftrue .NoAppear
	readvar VAR_WEEKDAY
	ifequal SATURDAY, .Appear
.NoAppear:
	disappear SATURDAY_LICKITUNG
	endcallback

.Appear:
	appear SATURDAY_LICKITUNG
	endcallback
...
SaturdayLickitung:
	...
	startbattle
	disappear SATURDAY_LICKITUNG
	setflag ENGINE_SATURDAY_LICKITUNG
...
Route18_MapEvents:
	...
	object_event  9,  2, SPRITE_LICKITUNG, SPRITEMOVEDATA_POKEMON, 1, 1, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, SaturdayLickitung, EVENT_SATURDAY_LICKITUNG
