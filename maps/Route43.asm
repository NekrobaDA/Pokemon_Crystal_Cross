...
Route43_MapScripts:
	...
	callback MAPCALLBACK_OBJECTS, .Sudowoodo
...
.Sudowoodo:
	checkflag ENGINE_THURSDAY_SUDOWOODO
	iftrue .NoAppear
	readvar VAR_WEEKDAY
	ifequal THURSDAY, .Appear
.NoAppear:
	disappear THURSDAY_SUDOWOODO
	endcallback

.Appear:
	appear THURSDAY_SUDOWOODO
	endcallback
...
ThursdaySudowoodo:
	...
	startbattle
	disappear THURSDAY_SUDOWOODO
	setflag ENGINE_THURSDAY_SUDOWOODO
...
Route43_MapEvents:
	...
	object_event 10, 40, SPRITE_SUDOWOODO, SPRITEMOVEDATA_POKEMON, 1, 1, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, ThursdaySudowoodo, EVENT_THURSDAY_SUDOWOODO
