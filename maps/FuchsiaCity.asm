...
FuchsiaCity_MapEvents:
	...
	def_warp_events
	warp_event 13, 13, FUCHSIA_MART, 2
	warp_event 24, 13, SAFARI_ZONE_MAIN_OFFICE, 1
	...
	def_bg_events
	bg_event 23, 20, BGEVENT_READ, FuchsiaCitySign
	bg_event  5, 29, BGEVENT_READ, FuchsiaGymSign
	bg_event 26, 14, BGEVENT_READ, SafariZoneOfficeSign
	bg_event 29, 30, BGEVENT_READ, WardensHomeSign
	bg_event  1,  1, BGEVENT_READ, SafariZoneClosedSign
	bg_event 10, 14, BGEVENT_READ, NoLitteringSign
	bg_event 18, 27, BGEVENT_READ, FuchsiaCityPokecenterSign
	bg_event 14, 13, BGEVENT_READ, FuchsiaCityMartSign

	def_object_events
	object_event 30, 21, SPRITE_YOUNGSTER, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, FuchsiaCityYoungster, -1
	object_event 13,  7, SPRITE_POKEFAN_M, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, FuchsiaCityPokefanM, -1
	object_event 16, 14, SPRITE_TEACHER, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, FuchsiaCityTeacher, -1
	object_event 23,  7, SPRITE_FRUIT_TREE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, FuchsiaCityFruitTree, -1
