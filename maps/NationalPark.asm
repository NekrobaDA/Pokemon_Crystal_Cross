	...
	const SUNDAY_SUNFLORA

NationalPark_MapScripts:
	def_scene_scripts

	def_callbacks
	callback MAPCALLBACK_OBJECTS, .Sunflora
	
.Sunflora:
	checkflag ENGINE_SUNDAY_SUNFLORA
	iftrue .NoAppear
	readvar VAR_WEEKDAY
	ifequal SUNDAY, .Appear
.NoAppear:
	disappear SUNDAY_SUNFLORA
	endcallback

.Appear:
	appear SUNDAY_SUNFLORA
	endcallback

SundaySunflora:
	faceplayer
	cry SUNFLORA
	loadwildmon SUNFLORA, 20
	startbattle
	disappear SUNDAY_SUNFLORA
	setflag ENGINE_SUNDAY_SUNFLORA
...
NationalPark_MapEvents:
	...
	object_event 14,  4, SPRITE_POKEFAN_F, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_ROCK, OBJECTTYPE_SCRIPT, 0, NationalParkPokefanFScript, -1
	...
	object_event  5,  3, SPRITE_SUNFLORA, SPRITEMOVEDATA_STILL, 1, 1, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, SundaySunflora, EVENT_SUNDAY_SUNFLORA
