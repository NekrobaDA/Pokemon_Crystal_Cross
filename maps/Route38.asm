...
Route38_MapEvents:
	...
	bg_event 13,  7, BGEVENT_READ, Route38TrainerTips

	def_object_events
	object_event  1,  6, SPRITE_STANDING_YOUNGSTER, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_TRAINER, 1, TrainerSchoolboyChad1, -1
