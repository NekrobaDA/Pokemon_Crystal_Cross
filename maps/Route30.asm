...
Route30_MapEvents:
	...
	def_bg_events
	bg_event  7, 47, BGEVENT_READ, Route30Sign
	...
	object_event  3,  5, SPRITE_BUG_CATCHER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_ROCK, OBJECTTYPE_TRAINER, 3, TrainerBugCatcherDon, -1
	...
	object_event 16, 39, SPRITE_FRUIT_TREE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route30FruitTree1, -1
