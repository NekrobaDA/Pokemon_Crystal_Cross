...
COLL_STAIRS_DOWN_RIGHT EQU $d0
COLL_STAIRS_DOWN_LEFT  EQU $d1
COLL_STAIRS_UP_RIGHT   EQU $d2
COLL_STAIRS_UP_LEFT    EQU $d3
COLL_ROCK_SMASH        EQU $de
COLL_LOG               EQU $df
COLL_BUSH              EQU $e0
