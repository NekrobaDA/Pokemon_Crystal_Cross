...
; Marts indexes (see data/items/marts.asm)
	...
	const MART_GOLDENROD_5F_6
	const MART_GOLDENROD_5F_7
	const MART_GOLDENROD_5F_8
	const MART_GOLDENROD_5F_9
	const MART_GOLDENROD_5F_10
	const MART_GOLDENROD_5F_11
	const MART_GOLDENROD_5F_12
	const MART_GOLDENROD_5F_13
	const MART_GOLDENROD_5F_14
	const MART_GOLDENROD_5F_15
	const MART_OLIVINE
	const MART_ECRUTEAK
