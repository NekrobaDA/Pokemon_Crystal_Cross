...
; GetPredefPal arguments (see engine/gfx/color.asm)
	...
	const PREDEFPAL_CATALLIA
	const PREDEFPAL_SEVII_ONE
	const PREDEFPAL_SEVII_TWO
	const PREDEFPAL_SEVII_THREE
	const PREDEFPAL_SEVII_FOUR
	const PREDEFPAL_SEVII_FIVE
	const PREDEFPAL_SEVII_SIX
	const PREDEFPAL_SEVII_SEVEN
	const PREDEFPAL_CHERRYGROVENEO
	const PREDEFPAL_UNDERWATER
	const PREDEFPAL_SECRET_BASE
	const PREDEFPAL_JOHTO_SAFARI
	...
	const PREDEFPAL_BLACKOUT_N
	const PREDEFPAL_BLACKOUT_E
