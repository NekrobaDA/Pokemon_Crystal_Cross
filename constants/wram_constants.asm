...
; wDailyFlags2::
	...
	const DAILYFLAGS4_BEAT_FALKNER_F
	const DAILYFLAGS4_BEAT_BUGSY_F
	const DAILYFLAGS4_BEAT_WHITNEY_F
	
	const_def
	const DAILYFLAGS5_BEAT_MORTY_F
	const DAILYFLAGS5_BEAT_JASMINE_F
	const DAILYFLAGS5_BEAT_CHUCK_F
	const DAILYFLAGS5_BEAT_PRYCE_F
	const DAILYFLAGS5_BEAT_CLAIR_F
...
; wSwarmFlags::
	...
	const SWARMFLAGS_VULPIX_SWARM_F
