...
TRAINERTYPE_GENDERS    EQU 1 << TRAINERTYPE_GENDERS_F
...
F_HP_FIRE    EQU $CD2C
SHINY_M_ALT_DVS  EQU $DDDD
SHINY_F_ALT_DVS  EQU $DD3D
;these no longer actually matter for genders, but do for Hidden Power still
