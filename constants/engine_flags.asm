...
; wVisitedSpawns
	...
	const ENGINE_FLYPOINT_ONE
	const ENGINE_FLYPOINT_TWO
	const ENGINE_FLYPOINT_THREE
	const ENGINE_FLYPOINT_FOUR
	const ENGINE_FLYPOINT_FIVE
	const ENGINE_FLYPOINT_SIX
	const ENGINE_FLYPOINT_SEVEN
...
; wDailyFlags3
	const ENGINE_SUNDAY_SUNFLORA
	const ENGINE_SUNDAY_ELECTABUZZ
	const ENGINE_MONDAY_SNORLAX
	const ENGINE_MONDAY_MAGMAR
	const ENGINE_TUESDAY_FARFETCHD
	const ENGINE_TUESDAY_MAROWAK
	const ENGINE_WEDNESDAY_SMEARGLE
	const ENGINE_WEDNESDAY_AERODACTYL
; wDailyFlags4
	const ENGINE_THURSDAY_SUDOWOODO
	const ENGINE_THURSDAY_DRAGONAIR
	const ENGINE_FRIDAY_RAPIDASH
	const ENGINE_SATURDAY_LICKITUNG
	const ENGINE_SATURDAY_EEVEE
