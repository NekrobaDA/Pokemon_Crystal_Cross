...
SEVII_LANDMARK EQU const_value
	...
	const LANDMARK_CAPE_BRINK
	const LANDMARK_THREE_ISLAND
	const LANDMARK_BOND_BRIDGE
	const LANDMARK_BERRY_FOREST
	const LANDMARK_FOUR_ISLAND
	const LANDMARK_ICEFALL_CAVE
	const LANDMARK_FIVE_ISLAND
	const LANDMARK_FIVE_ISLE_MEADOW
	const LANDMARK_SIX_ISLAND
	const LANDMARK_WATER_PATH
	const LANDMARK_RUIN_VALLEY
	const LANDMARK_PATTERN_BUSH
	const LANDMARK_SEVEN_ISLAND
	const LANDMARK_BATTLE_TOWER      ; 1d
	const LANDMARK_CANYON_ENTRANCE
	const LANDMARK_SEVAULT_CANYON
